...
const typeHints = {
  income: "Los ingresos aumentan el saldo real.",
  expense: "Los gastos débito bajan el saldo real.",
  card_purchase: "Las compras de crédito bajan el saldo real y aumentan el total crédito.",
  card_payment: "El pago de tarjeta solo baja el total crédito. No modifica el saldo real."
};
...
const movementHint = document.querySelector("#movementHint");
...
function updateCategoryField() {
  ...
  movementHint.textContent = typeHints[selectedType] || "";
}
...
function showAppUpdate(worker) {
  ...
  if (!banner) {
    ...
    banner.style.cssText =
      "position:fixed;left:12px;right:12px;bottom:92px;z-index:9999;max-width:520px;margin:auto;padding:14px 15px;border-radius:18px;background:#fff;color:#17212b;box-shadow:0 12px 35px rgba(0,0,0,.22);border:1px solid #dfe7e3;font-family:system-ui,-apple-system,'Segoe UI',sans-serif;";
    banner.innerHTML =
